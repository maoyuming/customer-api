...
public class DateUtil {
    ...
    public static boolean isLteToday(String day){
    	Calendar today = Calendar.getInstance();
    	int todayday = Integer.parseInt(dateToStr(today.getTime(), "yyyyMMdd"));
    	int theday = Integer.parseInt(dateToStr(strToDate(day, "yyyy-MM-dd"),"yyyyMMdd"));
    	return theday>=todayday?true:false;
    }
}
