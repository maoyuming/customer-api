...
public class KafkaPushAspect {
    ...
    private Logger logger = LoggerFactory.getLogger(KafkaPushAspect.class);
    
  //配置切入点,该方法无方法体,主要为方便同类中其他方法使用此处配置的切入点
    @Pointcut("execution(* com.duantuke.api.kafka.push..*.*(..))")
    public void aspect(){   }
    ...
    public Object around(ProceedingJoinPoint proceeding) throws Throwable {
        ...
        String key = Config.getValue("kafka.consumer.pushswitch");
