package com.duantuke.api.kafka;
...
public class MessageProducer {
	 ...
	 * @param value
	 */
	@MkTopicProducer(topic = "commonSmsMsg", serializerClass = "com.mk.kafka.client.serializer.SerializerEncoder",replicationFactor = 12)
	 ...
	 * @param value
	 */
	@MkTopicProducer(topic = "templateSmsMsg", serializerClass = "com.mk.kafka.client.serializer.SerializerEncoder",replicationFactor = 12)
