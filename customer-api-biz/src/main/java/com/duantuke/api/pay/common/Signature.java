...
public class Signature {
    ...
    public static String getSign(Object o) throws IllegalAccessException {
        ...
        result += "key=" + PayConfig.WECHAT_KEY;
     ...
     * @throws SAXException
     */
    public static String getSignFromResponseString(String responseString) throws JDOMException, IOException  {
     ...
     * @throws SAXException
     */
    public static boolean checkIsSignValidFromResponseString(String responseString) throws JDOMException, IOException  {
